...
* [超大规模中文语料集](https://github.com/esbatmop/MNBVC) ⭐ 4,270 | 🐛 22 | 📅 2026-08-28: 超大规模中文语料集。对标chatGPT训练的40T数据。MNBVC数据集不但包括主流文化，也包括各个小众文化甚至火星文的数据。MNBVC数据集包括新闻、作文、小说、书籍、杂志、论文、台词、帖子、wiki、古诗、歌词、商品介绍、笑话、糗事、聊天记录等一切形式的纯文本中文数据。
...
| Qwen      | Alibaba Cloud                   | [Github](https://github.com/QwenLM/Qwen) ⭐ 21,672 \| 🐛 38 \| 🌐 Python \| 📅 2026-03-05                           |                                               |
